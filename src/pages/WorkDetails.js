...
import "../styles/WorkDetails.css";
import { Helmet } from "react-helmet-async";
// Import useNavigate for smooth client-side routing
...
    <>
      <Helmet>
        <title>Work Detail | {process.env.REACT_APP_APP_APP_NAME}</title>
      </Helmet>
      <Navbar />
      <section className="breadcrumb_area">
        <div className="container">
...
            <button
              className="big_btn shadow_box"
              // UPDATED: Use React Router's navigate function instead of window.location.href
