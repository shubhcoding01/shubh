                    ...
                    <div className='d-flex about_me_wrap align-items-end mb-30'>
                        ...
                        <div className="about_details" data-aos="zoom-in">
                            ...
                            <div className='about_details_inner shadow_box'>
                                ...
                                <p>
                                Full Stack Developer passionate about turning ideas into functional, high-performance web applications. 
                                I specialize in <span className="font-semibold">React.js</span> and <span className="font-semibold">Spring Boot</span>, 
                                focusing on creating efficient APIs, clean architecture, and smooth end-to-end user experiences. 
                                While I enjoy backend development the most, I also work across the full stack to build complete, production-ready solutions. 
                                Currently, I’m developing scalable projects that bridge great logic with practical usability.
                                </p>
